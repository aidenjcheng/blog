...
export const TableOfContents = ({
  ...
  return (
    <React.Fragment>
      ...
      <div
        className={cn(
          "-translate-y-1/2 fixed top-1/2 left-0 z-10 py-10 pl-3",
      ...
      <div
        className={cn(
          ...
          "fixed mt-0 w-full justify-start rounded-lg bg-background px-3 py-2 shadow-card transition-all sm:max-w-52 lg:max-w-1/2 dark:shadow-none",
