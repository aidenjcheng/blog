...
export const TableOfContents = ({
  ...
  return (
    <React.Fragment>
      ...
      <div
        className={cn(
          "-translate-y-1/2 fixed top-1/2 left-0 py-10 pl-3 z-10",
      ...
      <div
        className={cn(
          ...
          "fixed mt-0 justify-start rounded-lg bg-background px-3 py-2 shadow-card transition-all sm:max-w-52 lg:max-w-1/2 dark:shadow-none w-full",
      ...
      >
        ...
        <div className="flex w-full flex-col gap-0 text-sm">
          ...
          {headings.map((heading, i) => (
            <div
              key={heading.id}
              className="h-fit max-w-full truncate font-medium"
            >
              <button
                type="button"
                ...
                className={cn(
                  ...
                  i !== 0 &&
                    "mt-0 ml-3 w-full py-1 text-muted opacity-100 transition duration-200 ease-in-out hover:text-foreground",
                  // :
                  //   true,
